...
- Enroute IFR clearances can be coordinated with Mombasa Radar.
...
- **TIWI marker** - A school, Bongwe Primary to the northeast of Mwakola Dam approximately 4NM to the airport. (Wide right base RWY19)
- **PENGO marker** - A school, Mwamanga Primary school, approximately 7nm to the southeast of Kinango town / 7.9NM to the southwest of Kwale town
- **LANZE marker** - A sparse residential area, near the town of Kifyonzo (coordinates 041145.660 S0391450.370E)  
  **NOTE: LANZE marker is only available when HKR11 is not active**
...
Diani has one access lane for a northwesterly departure, following this route:

- When HKR11 is active:
  - TIWI marker
  - PENGO marker
...
Minimum recommended altitude for access lane is FL28.
